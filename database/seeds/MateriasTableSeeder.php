...
class MateriasTableSeeder extends Seeder
{
    ...
    protected function materiasMedicina()
    {
        $id_carrera = Carrera::where('nombre', 'Medicina')->value('id');

        $lista1 =
            [
                ['xxx01', 'Problemas de Historia Argentina'], 
                ['xxx02', 'Taller de Lectura y Escritura'], 
                ['xxx03', 'Matemáticas'], 
                ['xxx04', 'Practicas Culturales'],
                ['xxx05', 'Conocimiento y Ciencias de la salud'], 
                ['xxx06', 'Biologia para Ciencias de la Salud'],
                ['xxx07', 'Fisica y Quimica para Ciencias de la Salud'],
                ['xxx08', 'Salud Publica'], 
            ];
        $this->crear_materias($lista1, 1, $id_carrera);
        ...
        $lista3 =
            [
                ['xxx15','Transporte e intercambio'],
                ['xxx16','Ser humano y entorno'],
                ['xxx17','Genero, sexualidad y reproduccion'],
                ['xxx18','Articulacion comunitaria II'],
                ['xxx19','Bioetica'],
                ['xxx20','Metodologia de la investigacion cientifica'],
            ];
        $this->crear_materias($lista3, 3, $id_carrera);

        $lista4 =
            [
               ['xxx21','Agresion infectologica-inmunitaria'],
               ['xxx22','Toxico-farmacologia'],
               ['xxx23','Condiciones de vida. Autoagresion y estres'],
               ['xxx24','Epidemiologia'],
               ['xxx25','Organizacion de servicios de la salud'],
               ['xxx26','Salud mental'],
               ['xxx27','Articulacion comunitaria III'],
            ];
        $this->crear_materias($lista4, 4, $id_carrera);

        $lista5 =
            [
                ['xxx28', 'Salud y enfermedad en la infancia y adolescencia I'], 
                ['xxx29', 'Salud y enfermedad en la mujer'],
                ['xxx30', 'Salud y enfermedad en el adulto I'], 
                ['xxx31', 'Gerontologia'],
                ['xxx32', 'Medicina legal'], 
                ['xxx33', 'Emergentologia'],
                ['xxx34', 'Salud del trabajo, el ocio y la recreacion'], 
                ['xxx35', 'Cuidados paliativos'],
            ];
            $this->crear_materias($lista5, 5, $id_carrera);    
        $lista6 = 
        [
            ['xxx36','Medicina familiar y comunitaria'],
            ['xxx37','Salud y enfermedad en la infancia y adolescencia II'],
            ['xxx38','Salud y enfermedad en el adulto II'],
            ['xxx39','Interconsulta y derivacion'],
        ];    
        $this->crear_materias($lista6, 6, $id_carrera);

        $lista7 = 
        [
            ['xxx41','Primer nivel de atencion'],
            ['xxx42','Atencion hospitalaria'],
            ['xxx43','Atencion hospilataria alta complejidad'],
            ['xxx44','Emergencias'],
            ['xxx45','Mercado de trabajo en salud'],
        ];
        $this->crear_materias($lista7, 7, $id_carrera);
    }

    //Materias de bioquimica
    protected function materiasBioquimica()
    {
        $id_carrera = Carrera::where('nombre', 'Bioquimica')->value('id');

        $lista1 =
            [
            ['cl001','Taller de lectura y escritura'],
            ['','Matematica'],
            ['','Problemas de historia argentina'],
            ['','Practicas culturales'],
            ['','Fisica y quimica para ciencias de la salud'],
        ...
        $lista3 =
            ...
            ['','Quimica analitica'],
            ['','Fisica II'],
            ['','Anatomia de histologia'],
            ['','Bioquimica I'],
            ['','Tecnicas analiticas intrumentales I'],
            ['','Bioestadistica'],
            ];
        $this->crear_materias($lista3, 3, $id_carrera);
        ...
        $lista4 =
            [
            ['','Tecnicas analiticas instrumentales II'],
            ['','Fisiologia'],
        ...
        ['','Hematologia'],
        ['','Medio interno y laboratorio de urgencias'],
        ['','Bromatologia'],
    ...
    //Materias de Lic. en Enfermeria
    $id_carrera = Carrera::where('nombre', 'Enfermeria')->value('id');

        $lista1 =
            [
            ['xxxx1','Problemas de Historia Argentina'],
            ['xxxx2','Taller de Lectura y Escritura'],
            ['xxxx3','Matemática'],
            ['xxxx4','Prácticas culturales'],
            ['xxxx5','Conocimiento y Ciencias de la salud'],
            ['xxxx6','Biología para ciencias de la salud'],
            ['','Fisica y quimica para ciencias de la salud'],
            ['','Salud pública'],
            ];
        $this->crear_materias($lista1, 1, $id_carrera);    
        ...
        $lista2 = [
            ['','Enfermería en cuidados básicos'],
            ['','Anatomía humana'],
            ['','Fisiología humana'],
        ...
        $lista3 = [
            ['','Cuidados integrales de la salud al adulto y anciano I'],
            ['','Cuidados integrales de la dalud materno infantil'],
            ['','Aspectos éticos y legales en enfermería'],
            ['','Metodología de la investigación científica'],
            ['','Cuidados integrales de la salud al adulto y el anciano II'],
            ['','Infecciones asociadas al cuidados de la salud'],
            ['','Cuidados integrales del niño y el adolescente'],
        ];
        $this->crear_materias($lista3,3,$id_carrera);
        ...
        $lista4 = [
            ...
            ['','Informatia aplicada a ciencias de la salud'],
            ['','Organizacion de servicios de salud'],
            ['','Práctica integrada I'],
            ['','Investigación en enfermería'],
            ['','Ética y deontología profesional'],
            ['','Gestión en enfermería I'],
            ['','Educación en salud'],
            ['','Cuidados integrales al paciente critico I'],
        ]:
        $this->crear_materias($lista4, 4, $id_carrera);

        $lista5 = [
            ['','Cuidados integrales al paciente critico II'],
            ['','Taller de investigacion en enfermeria'],
            ['','Gestion en enfermeria II'],
    ...
    //Materias de Licenciatura en organizacion y asistencia de quirofanos
    protected function materiasLOAQ(){
        $id_carrera = Carrera::where('nombre', 'LOAQ')->value('id');

        $lista1 = [
            ['','Problemas de historia argentina'],['','Taller de lectura y escritura'],['','Matemática'],['','Prácticas culturales'],['','Conocimiento y ciencias de la salud'],['','Biologia para ciencias de la salud'],['','Fisica y quimica para ciencias de la salud'],['','Salud publica'],

        ];
        $this->crear_materias($lista,,$id_carrera);
            
        $lista2 = [
            ['','Fundamentos de atencion  e instrumentacion quirurgica'],['','Bioseguridad'],['','Anatomia y fisiologia humana'],['','Psicologia'],['','Fundamentos eticos y de medicina legal'],['','Microbiologia'],['','Farmacologia'],['','Anestesiologia'],['','Organizacion de servicios de salud'],['','Anatomia quirurgica I'],
        ];
        $this->crear_materias($lista,,$id_carrera);
        ...
        $lista3 = [
            ...
            ['','Cirugia general'],
            ['','Procedimientos quirurgicos I'],
            ['','Procedimientos quirurgicos II'],
            ['','Procedimientos quirurgicos III'],
            ['','Cirugia pediatrica'],
        ...
        $lista4 = [
            ['','Didactica de la instrumentacion quirurgica'],
            ['','Quirurgica avanzada'],
            ['','Informatica aplicada a ciencias de la salud'],
            ['','Ingles aplicado a ciencias de la salud'],
            ['','Metodologia de la investigacion cientifica'],
            ['','Fundamentos juridicos basicos'],
